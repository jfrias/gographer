...
Create a gene pubmed graph from a \hyperlink{namespace_g_o_pubmed_graph}{GOPubmedGraph} and \hyperlink{namespace_g_o_gene_graph}{GOGeneGraph}. 


\begin{DoxyParams}{Parameters}
{\em gopubmedgraph} & The \hyperlink{namespace_g_o_pubmed_graph}{GOPubmedGraph} that should be merged to form the gene pubmed graph \\
\hline
{\em gogenegraph} & The \hyperlink{namespace_g_o_gene_graph}{GOGeneGraph} that should be merged to form the gene pubmed graph \\
\hline
\end{DoxyParams}
...
\item 
/Users/vickychen/Documents/Projects/myGOGrapher/gographer/\hyperlink{_g_o_gene_pubmed_graph_8py}{GOGenePubmedGraph.py}\end{DoxyCompactItemize}
